                       ...
                       <div className="col-xl-2 divrating" >
                        ...
                        {this.state.showComponent_sort &&
                                  ...
                                  <div className="container_sort ">
                                      ...
                                      <label className="col11 trend" for="trend">Top Trending</label>
                                ...
                                {/* { this.state.projectdetails && */}
                                  ...
                                  {/* <h2>MAP COMES HERE</h2> */}
                                      <div className="row">
                                            ...
                                            <div className="col-md-8"  style={{'marginTop':'4%', 'marginBottom':'6%', 'paddingLeft':'4%'}}>
...
{this.state.registerComponent &&
  ...
  {this.state.ListisOpen &&
       <div className="list_isopen_projects_mob">
          ...
          <div className="grid-container313_mob">
                {this.state.filtered_projectdetails? all_project:this.state.loading?<div className="sweet-loading">
        <ClipLoader
          ...
          loading={this.state.loading}
        />
      </div>:<div className="grid-container313_mob"><h2 className="no_projects">no projects</h2></div>}
          </div>
        </div>
            </div>
...
<div style={{'marginTop':'57%', 'marginBottom':'6%', 'paddingLeft':'4%'}} className="col-md-12 ">
    
     <MapLocations locations = {locationsData1}/>
   
  </div>
</div>
</div>:this.state.loading?<div className="grid-container313_mob"><div className="sweet-loading">
        <ClipLoader
          ...
          loading={this.state.loading}
        />
      </div></div>:<div className="grid-container313_mob"><h2 className="no_projects">no projects</h2></div>
                }
                                  {/* "No Map Data Available" */}
                                {/* } */}
...
//                         { searched_location.map((searched_location, i) => {
//                             return (
//                                 <li className="filter_li" key={i}> {searched_location} <button className="filter_btn" onClick={() => this.removeLocation(i)}>+</button> </li>
//                             )
//                         }) }
//                         <li className="input-location">
//                             <input onKeyDown={this.addLocation} type="text" size="4" ref={this.inputRef} />
...
//         <div className="col-lg-3 reviewbar">
          
//           {/* <div className="row">
//             <div className="col-md-9 reviewbar"> */}
//              <span className="locationstyle">MUMBAI</span>
//             {/* </div> */}
//             {/* <div className="col-md-3"> */}
...
//     {/* <div className="mobileContainer mobile-view-1st-row">
//       <div className="container-fluid">
//         <div className="row reviewrow custommargin">
//               <div className="col-9 flexstyle">
//                 <h3 className="mobile-toplogo">LOGO</h3><input className="searchbarstyle" type="text" placeholder="Search Property, Location..."/>
//               </div>
...
//               <span className="locationstyle">Surat</span>
...
//                         <div className="col-3 centeralign customnavpadding veticallyalign" style={{backgroundColor:this.state.menu1,color:this.state.menutext1}}>
//                         <a className="navbar-brand-mobile" href="#ratingdiv" style={{color:this.state.menutext1}} onClick={(e) => this.colorchange(1, e)}>RATINGS</a>
//                         </div>
//                         <div className="col-3 centeralign customnavpadding veticallyalign" style={{backgroundColor:this.state.menu2,color:this.state.menutext2}}>
//                         <a className="navbar-brand-mobile" href="#reviewdiv" style={{color:this.state.menutext2}} onClick={(e) => this.colorchange(2, e)}>REVIEWS</a>
//                         </div>
//                         <div className="col-3 centeralign customnavpadding veticallyalign" style={{backgroundColor:this.state.menu3,color:this.state.menutext3}}>
//                         <a className="navbar-brand-mobile" href="#recenttransactiondiv" style={{color:this.state.menutext3}} onClick={(e) => this.colorchange(3, e)}>RECENT TRANSACTIONS</a>
//                         </div>
//                         <div className="col-3 centeralign customnavpadding veticallyalign" style={{backgroundColor:this.state.menu4,color:this.state.menutext4}}>
//                         <a className="navbar-brand-mobile" href="#projectinfodiv"  style={{color:this.state.menutext4}} onClick={(e) => this.colorchange(4, e)}>PROJECT INFO</a>
//                         </div>    
//             </div>     
//           </div>   
//         </div>
...
//         <div className="row"> 
//                         <div className="col-xl-2 centeralign">
//                         <button className="btn"> Rating <img className="addimagestyle" src={down}/></button>
//                         </div>
//                         <div className="col-xl-2 centeralign">
//                         <button className="btn"> Property Type <img className="addimagestyle" src={down}/></button>
//                         </div>
//                         <div className="col-xl-2 centeralign">
//                         <button className="btn"> Budget <img className="addimagestyle" src={down}/></button>
//                         </div>
//                         <div className="col-xl-2 centeralign">
//                         <button className="btn"> Amenities <img className="addimagestyle" src={down}/></button>
//                         </div>
//                         <div className="col-xl-2 centeralign">
//                         <button className="btn"> Possession <img className="addimagestyle" src={down}/></button>
//                         </div>
//                         <div className="col-xl-2 centeralign">
//                         <button className="btn"> Sort by <img className="addimagestyle" src={down}/></button>
//                         </div>
...
//         <button className="btn"><img className="addimagestyle" src={addimage}/> Share Views</button>
