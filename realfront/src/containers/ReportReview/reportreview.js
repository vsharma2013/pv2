...
class ReportReview extends React.Component{
  ...
  handleSubmit(event) {
    ...
    axios.post('https://www.propviewz.com/be/save_reported_review/', {     
      project_id:this.state.reviewdetails[0].project_id,
      review_id:this.state.reviewdetails[0].review_id,
  ...
  reviewdetails = async () =>{
    ...
    let reviewdetails = await axios.get(`https://www.propviewz.com/be/review_info/`+review_id); 
